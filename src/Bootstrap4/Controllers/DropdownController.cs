...
namespace Bootstrap4.Controllers
{
    public class DropdownController : Controller
    {
        public IActionResult Index(int id = 2)
        {
            ...
            var vicePresident = new EmployeeModel
            {
                Id = 2,
                Name = "Andrew Fuller",
            ...
            var salesManager = new EmployeeModel
            {
                Id = 5,
        ...
        private EmployeeModel GetEmployees(int id)
        {
            if (id == 2)
            {
                var vicePresident = new EmployeeModel
                ...
                var vicePresidentEmployees = new List<EmployeeModel>
                {
                    ...
                    new EmployeeModel { Id = 3, Name = "Janet Leverling",
                    JobTitle = "Sales Representative", ReportsTo = 2 },
                    new EmployeeModel { Id = 4, Name = "Laura Callahan",
                    JobTitle = "Inside Sales Coordinator", ReportsTo = 2 }
                };
